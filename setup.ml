(* OASIS_START *)
(* DO NOT EDIT (digest: b1cc0621945a8e08c859f48aa737ccda) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "bapbuild"];
                      bs_c_sources = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bap", None);
                           InternalLibrary "bap-frames";
                           InternalLibrary "bap-plugin-frames";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\250\254d\198?\190\219h\236\149\186\1785tZ{";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
